...
export { addArchitecture, readAllArchitecture, getOneArchitecture, deleteOneArchitecture, updateOneArchitecture, readAllPaginatedArchitecture, readAllPaginatedArchitectureHistory }